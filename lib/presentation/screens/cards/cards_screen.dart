  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
        children: [
          ...cards.map((card) =>
              _CardTypel(label: card['label'], elevation: card['elevation'])),
          ...cards.map((card) =>
...
class _CardTypel extends StatelessWidget {
  final String label;
  final double elevation;

  const _CardTypel({required this.label, required this.elevation});
